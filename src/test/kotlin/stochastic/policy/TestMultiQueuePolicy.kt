...
class TestMultiQueuePolicy {
    ...
    fun compareSimulationWithEstimate() {
        val stochasticPolicy: StochasticOffloadingPolicy = RangedOptimalPolicyFinder.findOptimalPolicy(
        ...
        val delayOffloadOnly = simulator.simulatePolicy(OffloadOnlyPolicy, 2_000_000).averageDelay
